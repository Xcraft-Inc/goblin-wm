...
const windowStateKeeper = require('./stateKeeper.js');
...
Goblin.registerQuest(
  ...
  function*(quest, labId, url, options, next) {
    ...
    const mainWindowStateKeeper = windowStateKeeper(mainGoblin);

    const getBrowserWindowOptions = () => {
      const wmConfig = require('xcraft-core-etc')().load('goblin-wm');
      const winOptions =
        mainWindowStateKeeper.windowOptions || wmConfig.windowOptions || {};
